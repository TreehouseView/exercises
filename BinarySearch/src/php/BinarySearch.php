...
var_dump(binarySearch($list, 4) . ' = -1');
var_dump(binarySearch($list, 5) . ' = 2');
var_dump(binarySearch($list, 21) . ' = 10');
var_dump(binarySearch($list, 100) . ' = -1');
var_dump(binarySearch($list, -4) . ' = -1');
var_dump(binarySearch($list, 99) . ' = 16');
var_dump(binarySearch($list, 23) . ' = 12');
